  ...
  return (
    <div className='app_container'>
      <Canvas>
        ...
        <Model customeColor = {{mesh:mesh, lace:lace, caps:caps, inner:inner, sole:sole, stripes:stripes, band:band, patch:patch}}/>
      ...
      <div>
        ...
        <input type="color" id="caps" name="caps" value={caps} onChange={(e)=> setCaps(e.target.value)}/>
        <label for="caps">EYELET</label>
        <input type="color" id="inner" name="inner" value={inner} onChange={(e)=> setInner(e.target.value)}/>
        ...
        <input type="color" id="band" name="band" value={band} onChange={(e)=> setBand(e.target.value)}/>
        <label for="band">PULL TAB</label>
        <input type="color" id="patch" name="patch" value={patch} onChange={(e)=> setPatch(e.target.value)}/>
